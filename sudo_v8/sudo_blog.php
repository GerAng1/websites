...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light">
      <a class="navbar-brand" href="sudo_blog.php"><img src="assets/pics/logo_sudo.png" height="30" alt="Logo SUDO"> SUDO News</a>
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="#">Pasados</a>
    ...
    <button class="btn btn-link d-block mx-auto" data-toggle="collapse" data-target="#collapseExample" type="button"
      ...
      Al usar este sitio acepto a comer cookies.
    </button>
    ...
    <div class="container">
      <div class="row">
        <div class="col">
          ...
          <div class="jumbotron h-md-50 mx-2"
            style="background-image: url(assets/pics/bg_it.png); background-size: cover; background-repeat: no-repeat;">
            <div class="px-3 h-100 text-white" style="background-color: rgba(0,0,0, 0.4); overflow: auto">
              <h1>Hay más a las computadoras que el ojo ve...</h1>
              <p class="text-right">...también estan todos los componentes.</p>
            </div>
          </div>
          <!-- End of Jumbotron -->
        </div>
      ...
      <div class="row">
        <div class="col">
          <h1 class="text-center">Curioso? Aprende más:</h1>
        </div>
      </div>
